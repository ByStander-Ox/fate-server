...
const SyncMovementBehaviour = require("../behaviour/sync_movement.js");
const SyncEntityBehaviour = require("../behaviour/sync_entity.js");
const SyncRotateBehaviour = require("../behaviour/sync_rotation");
...
class Server {
    constructor(settings) {
        ...
        ChatBehaviour(this);
        BanBehaviour(this);
        SyncMovementBehaviour(this);
        SyncEntityBehaviour(this);
        SyncRotateBehaviour(this);
    }
